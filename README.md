## 项目名称
[![](https://www.herokucdn.com/deploy/button.png)](https://heroku.com/deploy?template=https://github.com/gitcanc/xange.git)
...
![image](https://github.com/gitcanc/xange/blob/master/doc/1.png)

请求`/speedtest/`，html5-speedtest测速页面

![image](https://github.com/gitcanc/xange/blob/master/doc/2.png)

请求`/test/`，文件下载速度测试

![image](https://github.com/gitcanc/xange/blob/master/doc/3.png)
